import requests
from spaceid_py.metadata import TLD_CHAIN_MAP
...
class SpaceIDClient:
    def __init__(self, base_url: str = BASE_URL):
        ...
        self.supported_tlds = list(TLD_CHAIN_MAP.keys())
        self.supported_chains = list(TLD_CHAIN_MAP.values())
        self.tld_chain_map = TLD_CHAIN_MAP
